 ...
 * KVSTLS_send() — defined in ice_controller_net.c, see rationale
 * there.  Every KVSTLS_recv() in this file must go through
 * prvTlsRecvLocked(). */
                                 ...
                                 size_t bufferSize )
{
    ...
    ret = KVSTLS_recv( pTlsNetworkContext, pBuffer, bufferSize );
