 ...
 *
 * IOTCONNECT "Telemetry Files" device-to-cloud file upload, FSP/FreeRTOS
 * port (AWS backends).
 *
 * Wire protocol (mirrors the IOTCONNECT Python Lite SDK):
 ...
 *              "snap-1234.jpg" (no leading slash, no "device-uploads/").
 * data/len     file body.
 * content_type e.g. "image/jpeg" (NULL -> "application/octet-stream").
 * cf_json      optional Classification: either a JSON object string
 *              (e.g. "{\"class\":\"person\",\"score\":91}") or a plain
