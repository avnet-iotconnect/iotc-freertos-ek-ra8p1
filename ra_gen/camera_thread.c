...
const timer_cfg_t g_timer_camera_xclk_cfg =
{
    ...
    /* Actual period: 4.166666666666667e-8 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0xa, .duty_cycle_counts = 0x5, .source_div = (timer_source_div_t)0,
    .channel             = 12,
    .p_callback          = NULL,
...
{
    .p_ctrl        = &g_timer_camera_xclk_ctrl,
    .p_cfg         = &g_timer_camera_xclk_cfg,
