...
#include "ai_inference_thread.h"
                ...
                static uint8_t ai_inference_thread_stack[0x2000] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
                static uint8_t ai_inference_thread_stack[0x2000] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.ai_inference_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #endif
                #endif
...
extern uint32_t g_fsp_common_thread_count;
                ...
                void ai_inference_thread_create (void)
                {
                    ...
                    BaseType_t ai_inference_thread_create_err = xTaskCreate(
                        ...
                        (const char *)"AI Inference Thread",
                        0x2000/4, // In words, not bytes
