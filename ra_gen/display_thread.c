...
#include "display_thread.h"
                ...
                static uint8_t display_thread_stack[0x2000] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
                static uint8_t display_thread_stack[0x2000] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.display_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #endif
                #endif
