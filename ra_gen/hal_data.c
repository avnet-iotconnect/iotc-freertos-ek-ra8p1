...
sci_b_uart_instance_ctrl_t     g_console_output_uart_ctrl;
            ...
            {
                /* Baud rate calculated with 1.725% error. */ .baudrate_bits_b.abcse = 0, .baudrate_bits_b.abcs = 0, .baudrate_bits_b.bgdm = 1, .baudrate_bits_b.cks = 0, .baudrate_bits_b.brr = 31, .baudrate_bits_b.mddr = (uint8_t) 256, .baudrate_bits_b.brme = false
            };
            ...
            const uart_cfg_t g_console_output_uart_cfg =
            {
                ...
                .p_callback          = console_output_uart_callback,
                .p_context           = NULL,
                .p_extend            = &g_console_output_uart_cfg_extend,
...
{
    .p_ctrl        = &g_console_output_uart_ctrl,
    .p_cfg         = &g_console_output_uart_cfg,
...
const timer_cfg_t g_time_counter_cfg =
{
    ...
    /* Actual period: 0.0001 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x5dc0, .duty_cycle_counts = 0x2ee0, .source_div = (timer_source_div_t)0,
    .channel             = 0,
    .p_callback          = time_counter_callback,
...
{
    .p_ctrl        = &g_time_counter_ctrl,
    .p_cfg         = &g_time_counter_cfg,
    .p_api         = &g_timer_on_gpt
};
iic_master_instance_ctrl_t g_i2c_master_board_ctrl;
const iic_master_extended_cfg_t g_i2c_master_board_extend =
{
...
const i2c_master_cfg_t g_i2c_master_board_cfg =
{
    .channel             = 1,
...
#endif
#undef RA_NOT_DEFINED
    .p_callback          = g_board_i2c_master_cb,
    .p_context           = NULL,
...
#endif
    .ipl                 = (4),
    .p_extend            = &g_i2c_master_board_extend,
};
/* Instance structure to use this module. */
const i2c_master_instance_t g_i2c_master_board =
{
    .p_ctrl        = &g_i2c_master_board_ctrl,
    .p_cfg         = &g_i2c_master_board_cfg,
