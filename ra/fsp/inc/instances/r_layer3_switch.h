...
typedef struct st_layer3_switch_descriptor
{
    ...
    union
    {
        ...
        struct /*st_info1_rx*/
        {
            ...
            /*vol*/          uint8_t : 1;   ///< 7 (1 bit),        Reserved.
        ...
        struct /*st_info1_tx*/
        {
            ...
            /*vol*/         uint8_t : 3; ///< 24..26 (3 bits), Reserved.
    ...
    union
    {
        ...
        struct /*st_reception_direct_descriptor*/
        {
            ...
            /*vol*/          uint8_t : 1; ///< 15 (1 bit),      Reserved
            volatile uint8_t  dv      : 7; ///< 16..22 (7 bit),  Destination vector
            /*vol*/          uint8_t : 1; ///< 23 (1 bit),      Reserved
